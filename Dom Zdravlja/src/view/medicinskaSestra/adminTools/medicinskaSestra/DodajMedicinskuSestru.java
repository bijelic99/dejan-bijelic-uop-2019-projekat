...
public class DodajMedicinskuSestru extends JPanel {
	...
	public DodajMedicinskuSestru() {
		setBorder(new TitledBorder(null, "Dodaj Medicinsku Sestru", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		comboBox.addItemListener(new ItemListener() {
			public void itemStateChanged(ItemEvent e) {
				if(comboBox.getSelectedIndex() != -1) {
					comboBox_1.setModel(new DefaultComboBoxModel<Sluzba>(((DomZdravlja)comboBox.getSelectedItem()).getSluzbe().toArray(Sluzba[]::new)));
